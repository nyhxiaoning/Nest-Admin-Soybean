const local: App.I18n.Schema = {
  ...
  route: {
    ...
    tool: '系统工具',
    tool_gen: '代码生成',
    tool_gen_datasource: '数据源管理',
    tool_gen_template: '模板管理',
    tool_gen_history: '生成历史',
    tool_build: '表单构建',
    tool_swagger: '系统API',
    system_user: '用户管理',
    system_dict: '字典管理',
    ...
    system_sms: '短信管理',
    system_sms_channel: '短信渠道',
    system_sms_template: '短信模板',
    system_sms_log: '短信日志',
    system_notify: '站内信管理',
    system_notify_template: '站内信模板',
  ...
  page: {
    ...
    fileManager: {
      ...
      folderRenameNotImplemented: '文件夹重命名功能暂未实现',
      pleaseSelectItemsToDelete: '请选择要删除的项目',
      pleaseSelectFilesToMove: '请选择要移动的文件',
      cannotMoveFolders: '暂不支持移动文件夹',
      pleaseSelectFilesToShare: '请选择要分享的文件',
      cannotShareFolders: '暂不支持分享文件夹',
      pleaseSelectFilesToDownload: '请选择要下载的文件',
      batchDownloadNotImplemented: '批量下载功能暂未实现',
      sharedNotImplemented: '分享功能暂未实现',
      recentNotImplemented: '最近文件功能暂未实现',
      pauseUploadNotImplemented: '暂停上传功能暂未实现',
      resumeUploadNotImplemented: '恢复上传功能暂未实现',
      retryUploadNotImplemented: '重试上传功能暂未实现'
    }
  },
  form: {
    required: '不能为空',
