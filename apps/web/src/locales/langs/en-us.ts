const local: App.I18n.Schema = {
  ...
  route: {
    ...
    tool_gen_datasource: 'Data Source Management',
    tool_gen_template: 'Template Management',
    tool_gen_history: 'Generation History',
    tool_build: 'Form Builder',
    ...
    system_sms: 'SMS Management',
    system_sms_channel: 'SMS Channel',
    system_sms_template: 'SMS Template',
    system_sms_log: 'SMS Log',
    system_notify: 'Notify Management',
    system_notify_template: 'Notify Template',
    system_notify_message: 'Notify Message',
    ...
    literature: 'Literature Editor',
    literature_workbench: 'Writing Workbench',
    literature_manuscripts: 'My Manuscripts',
    literature_materials: 'Material Library',
    literature_tags: 'Tag Management',
    literature_settings: 'Editor Settings',
    exception: 'Exception',
    exception_403: '403',
    exception_404: '404',
    exception_500: '500'
  ...
  page: {
    ...
    fileManager: {
      ...
      uploadPartialSuccess: 'Upload completed: {successCount} succeeded, {failedCount} failed',
      ...
      createShareSuccess: 'Share created successfully',
      batchShareSuccess: 'Successfully created {count} share links',
      batchSharePartialFailed: '{count} files failed to share',
      ...
      getVersionsFailed: 'Failed to get version history',
      restoreVersion: 'Restore Version',
      restoreVersionConfirm: 'Are you sure you want to restore to version {version}? This will create a new version.',
      restoreVersionSuccess: 'Restored to version {version}, new version is {newVersion}',
      restoreVersionFailed: 'Failed to restore version',
      fileModified: 'File has been modified, please refresh and try again',
      getRecycleListFailed: 'Failed to get recycle bin list',
      restoreFile: 'Restore File',
      restoreFileConfirm: 'Are you sure you want to restore {count} selected files?',
      restoreFileSuccess: 'Restore successful',
      ...
      folderRenameNotImplemented: 'Folder rename not implemented',
      pleaseSelectItemsToDelete: 'Please select items to delete',
      pleaseSelectFilesToMove: 'Please select files to move',
      cannotMoveFolders: 'Cannot move folders',
      pleaseSelectFilesToShare: 'Please select files to share',
      cannotShareFolders: 'Cannot share folders',
      pleaseSelectFilesToDownload: 'Please select files to download',
      batchDownloadNotImplemented: 'Batch download not implemented',
      sharedNotImplemented: 'Shared feature not implemented',
      recentNotImplemented: 'Recent files feature not implemented',
      pauseUploadNotImplemented: 'Pause upload not implemented',
      resumeUploadNotImplemented: 'Resume upload not implemented',
      retryUploadNotImplemented: 'Retry upload not implemented'
    }
  },
  form: {
