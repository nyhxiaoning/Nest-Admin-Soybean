...
export const views: Record<LastLevelRouteKey, RouteComponent | (() => Promise<RouteComponent>)> = {
  ...
  literature_manuscripts: () => import("@/views/literature/manuscripts/index.vue"),
  literature_materials: () => import("@/views/literature/materials/index.vue"),
  literature_print: () => import("@/views/literature/print/[id].vue"),
  literature_settings: () => import("@/views/literature/settings/index.vue"),
  literature_tags: () => import("@/views/literature/tags/index.vue"),
  literature_workbench: () => import("@/views/literature/workbench/index.vue"),
  ...
  system_notify_message: () => import("@/views/system/notify/message/index.vue"),
  system_notify_template: () => import("@/views/system/notify/template/index.vue"),
  ...
  system_sms_channel: () => import("@/views/system/sms/channel/index.vue"),
  system_sms_log: () => import("@/views/system/sms/log/index.vue"),
  system_sms_template: () => import("@/views/system/sms/template/index.vue"),
  ...
  tool_gen_template: () => import("@/views/tool/gen/template/index.vue"),
